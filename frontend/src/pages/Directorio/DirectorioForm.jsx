...
const DirectorioForm = ({
	...
	const opcionesLicencia = [
		{ value: "BUSINESS_STARTER", label: "Business Starter (30GB)" },
		{ value: "BUSINESS_STANDARD", label: "Business Standard (2TB)" },
	];
	...
	return (
		<form onSubmit={onSubmit} className='directorio-form'>
			...
			{modalMode === "BAJA" && (
				<div className='transfer-box' style={{ marginTop: "10px" }}>
					<div
						style={{
							marginBottom: "15px",
							color: "#b45309",
