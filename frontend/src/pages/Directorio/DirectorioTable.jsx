import { Mail, CornerDownRight, Edit, UserMinus } from "lucide-react";
import "./DirectorioTable.scss";

const DirectorioTable = ({ directorio, onEdit, onBaja }) => {
	...
	return (
		<div className='table-container dir-table'>
			<table>
				...
				<tbody>
					{directorio.map((d) => (
						<tr key={d.id} className={!d.estado ? "row-inactive" : ""}>
							<td>
								<span className='name'>
							...
							<td>
								...
								d.colaborador_destino_id ? (
									<div className='transfer-info'>
										<CornerDownRight size={14} className='icon-transfer' />
										<span>
											Transferido a:{" "}
											<strong>
