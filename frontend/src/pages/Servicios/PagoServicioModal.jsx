...
const PagoServicioModal = ({ servicio, onClose }) => {
	...
	const customSelectStyles = {
		...
		valueContainer: (provided) => ({
			...
			padding: "0 12px",
			height: "40px",
			position: "relative", // Requerido para el centrado absoluto interno
		}),
		input: (provided) => ({
			...provided,
			margin: "0px",
			padding: "0px",
			height: "40px",
			color: "transparent", // Evita saltos de línea extraños por el cursor de texto
		}),
		...
		singleValue: (provided) => ({
			...
			position: "absolute",
			top: "50%",
			transform: "translateY(-50%)", // Centrado matemático exacto
		}),
