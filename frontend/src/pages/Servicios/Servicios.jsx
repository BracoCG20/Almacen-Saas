...
const Servicios = () => {
			...
			steps: [
				{
					...
					popover: {
						...
						description:
							"Escribe el nombre del software o filtra por categorías.",
						side: "bottom",
						align: "start",
					},
				},
				{
					...
					popover: {
						...
						description: "Los servicios se ordenan automáticamente.",
						side: "top",
						align: "start",
					},
				},
	...
	return (
		<div className='servicios-container'>
			...
			<div className='table-container' id='tour-servicios-tabla'>
