...
const Devolucion = () => {
	...
	// --- NUEVA FUNCIÓN: REENVIAR CORREO DESDE LA TABLA ---
	const handleReenviarCorreo = async (item) => {
		...
		try {
			...
			fetchData(); // Refrescar la tabla para que salga el check verde
		} catch (e) {
			console.error(e);
			toast.update(toastId, {
		...
		<div className='devolucion-container'>
			...
			<div className='content-grid'>
				...
				<DevolucionTable
					...
					onReenviarCorreo={handleReenviarCorreo} // <--- Pasamos la función a la tabla
				/>
