...
const DevolucionForm = ({
	...
	// El ID 1 generalmente es "Operativo", evaluamos si el estado elegido indica daño
	// Esto dependerá de cómo llenaste tu BD, asumimos que ID > 1 es daño/mantenimiento
