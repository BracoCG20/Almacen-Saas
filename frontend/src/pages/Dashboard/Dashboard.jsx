...
const Dashboard = () => {
	...
	return (
		<div className='dashboard-container-modern'>
			...
			<div className='cost-summary-modern'>
				...
				<div className='cost-body'>
					{Object.keys(costosAgrupados).length === 0 ? (
						...
						Object.keys(costosAgrupados).map((moneda) => (
							<div className='currency-card' key={moneda}>
								...
								<TrendingUp size={32} className='bg-icon' />
							</div>
						))
					)}
				</div>
			...
			<div className='charts-grid-modern' style={{ marginBottom: "3rem" }}>
				<div className='chart-card'>
					<div className='chart-header'>
						<div className='indicator secondary'></div>
			...
			<div className='charts-masonry-modern'>
