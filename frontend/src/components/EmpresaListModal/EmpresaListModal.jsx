...
const EmpresaListModal = ({ onClose, onEditEmpresa }) => {
  ...
  return (
    ...
    >
      <div
        className='empresa-list-content-modern'
        onClick={(e) => e.stopPropagation()}
      >
        <div className='modal-header'>
          <h2>
            <Building2 size={20} /> Gestión de Empresas
          </h2>
          <button
            className='btn-close'
            onClick={onClose}
              ...
              <table>
                ...
                <tbody>
                  {currentItems.map((e) => (
                    <tr
                      key={e.id}
                      className={!e.estado ? 'inactive-row' : ''}
                    >
                      <td>
                        <div className='info-cell'>
                          ...
                          {e.nombre_comercial && (
                            <span className='audit-text'>{e.razon_social}</span>
                          )}
                        </div>
                      </td>
                      <td>
                        <span className='audit-text'>{e.ruc}</span>
                      </td>
                      <td>
                      ...
                      <td className='center'>
                        <span
                          className={`status-badge-mini ${e.estado ? 'active' : 'inactive'}`}
                        >
                      ...
                      <td className='center'>
                        <div className='actions-cell'>
                          <button
                            className={`action-btn-mini toggle ${e.estado ? 'danger' : 'success'}`}
