...
const FileUploader = ({
	...
	// Función para activar el input oculto al hacer clic en nuestro botón bonito
	...
	// 1. Mostrar archivo NUEVO seleccionado (con botón de descarga)
	if (newFile) {
	...
	// 3. Mostrar BOTÓN CUSTOMIZADO si no hay archivo (Reemplaza al feo del navegador)
	return (
