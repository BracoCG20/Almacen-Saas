...
// NUEVO: Importación correcta desde lucide-react
import {
	Home,
	Laptop,
	Users,
...
const Sidebar = () => {
	...
	// Definición de Rutas del Menú usando Lucide Icons (size 22 para que encajen perfecto)
	const routes = [
			...
			<div className='footer-actions'>
				<div className={`user-mini-card ${!isOpen ? "collapsed" : ""}`}>
					<div className='avatar'>
						{/* Lucide Icon para usuario sin foto */}
						{avatarUrl ? (
